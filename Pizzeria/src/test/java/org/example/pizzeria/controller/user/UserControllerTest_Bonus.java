...
class UserControllerTest_Bonus {
    ...
    void getUserBonus_UserNotFound_ThrowEntityInPizzeriaNotFoundException() throws Exception {
        long userId = 999L;
        doThrow(EntityInPizzeriaNotFoundException.class).when(userService).getUserBonus(userId);
    ...
    void updateUserBonus_UserNotFound_ThrowEntityInPizzeriaNotFoundException() throws Exception {
        long userId = 999L;
        doThrow(EntityInPizzeriaNotFoundException.class).when(userService).updateUserBonus(userId, 20, 375.0);
