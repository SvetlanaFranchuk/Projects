INSERT INTO users(login, password, email, birthdate, address, phone_number, is_Blocked, role) VALUES ('Admin', 'Qwerty', 'admin@pizza.com', '1990-01-01', '', '', false, 'ADMIN');
INSERT INTO users(login, password, email, birthdate, address, phone_number, is_Blocked, role) VALUES ('Manager', 'Ytrewq', 'manager@pizza.com', '1985-02-10','', '', false, 'MANAGER');
INSERT INTO users(login, password, email, birthdate, address, phone_number, is_Blocked, role) VALUES ('ivanov92', 'ivanov', 'ivanov92@pizza.com', '1991-01-17','Berlin, Rathausstrasse, 15', '+493090000000', false, 'CLIENT');
INSERT INTO users(login, password, email, birthdate, address, phone_number, is_Blocked, role) VALUES ('petrovPP', 'petrov', 'petrovPP@pizza.com', '1995-05-27','Berlin, Rathausstrasse, 45', '+493090000007', false, 'CLIENT');
...
INSERT INTO orders_details(delivery_date_time, order_id) VALUES ('2024-03-09', 1);
...
INSERT INTO bonuses(count_orders, sum_orders, order_details_id, user_app_id, type_bonuses) VALUES(1, 3.99,1,3, null);
